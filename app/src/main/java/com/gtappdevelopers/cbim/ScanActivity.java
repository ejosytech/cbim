    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        camera.setScannerViewEventListener(new ScannerLiveView.ScannerViewEventListener() {
            ...
            public void onScannerError(Throwable err) {
                ...
                Toast.makeText(ScanActivity.this, "Scanner Error: " + err.getMessage(), Toast.LENGTH_SHORT).show();
            }
            ...
            public void onCodeScanned(String data) {
                ...
                if (data.toString().equalsIgnoreCase("08033927733")) {
                    Intent intent = new Intent(ScanActivity.this, StatusActivity.class);
                    String trfContent = data.toString();
                    intent.putExtra("STRING_I_NEED", trfContent);
